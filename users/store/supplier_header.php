...
<div id="categoryBarWrapper" class="position-sticky top-0 bg-white border-bottom py-2 px-3" style="z-index: 1000; will-change: transform;">
    <div class="d-flex align-items-center position-relative">
        ...
        <div id="categoryBar" class="scroll-container flex-nowrap d-flex align-items-center overflow-hidden">
            <button class="btn  category-tab active" data-id="">All Ingredients</button>
        ...
        <!-- This is where ingredients will be injected -->
