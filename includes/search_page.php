...
// Handle basic plural stripping: "bananas" → "banana"
$altSearch = $search;
...
if ($search) {
  ...
  // Count total
  $countStmt = $pdo->prepare("SELECT COUNT(*) FROM ingredients WHERE ingredient_name LIKE ? OR ingredient_name LIKE ?");
  $countStmt->execute([$like, $altLike]);
