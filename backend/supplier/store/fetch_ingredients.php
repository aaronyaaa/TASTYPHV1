...
if (empty($ingredients)) {
    echo '<div class="text-center py-5">
            ...
            (!empty($search) ? 'No ingredients match your search criteria.' : 
            (!empty($categoryFilter) ? 'This category is currently empty.' : 
                    ...
                    <div class="ingredient-card-1">
                        ...
                        <div class="card-body">
                            ...
                            <div class="price-cart-container">
                                ...
                                <?php endif; ?>
                                <button class="add-to-cart-btn-1" title="Add to Cart">
