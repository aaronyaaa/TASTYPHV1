...
// Calculate total clicks for the whole campaign
$totalClicksStmt = $pdo->prepare("SELECT COUNT(*) FROM campaign_clicks WHERE campaign_id = ?");
$totalClicksStmt->execute([$campaignId]);
